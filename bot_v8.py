...
async def main():
    ...
    print("=" * 50, flush=True)
    print("🔧 ВЕРСИЯ КОДА: 3.0 (с группами обработчиков)", flush=True)
    print("=" * 50, flush=True)
    ...
    # Группа 0 - команды (низкий приоритет)
    # Группа 1 - callback'и (высокий приоритет)
    # Группа 2 - ConversationHandler (самый низкий приоритет)
    ...
    # Группа 1: Callback'и (высокий приоритет, обрабатываются первыми)
    ...
    # Выводим ВСЕ обработчики для проверки
