...
async def main():
    ...
    # ============================================================
    # ГЛОБАЛЬНЫЙ обработчик /start — регистрируется ПЕРВЫМ,
    # до ConversationHandler, чтобы перехватывать команду всегда
    # ============================================================
    telegram_app.add_handler(CommandHandler("start", global_start))
    # ============================================================
    
    conv_handler = ConversationHandler(
        entry_points=[],  # Убираем отсюда /start, он теперь глобальный
        states={
            TGState.MAIN_MENU: [
